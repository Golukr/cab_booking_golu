...
<body class="sub_page">
  ...
  <div class="container " style= "background-color:white; margin: auto; padding-top: 50px; margin-bottom: 50px;">
    <div class="d-flex justify-content-between">
      <h5 style="color: #ffc107;">Name : <p1 style="color: black;">${customer.userName}</p1></h5>
      <h5 style="color: #ffc107;">Ph.No. : <p1 style="color: black;">${customer.mobileNumber}</p1></h5>
      <h5 style="color: #ffc107;">Email : <p1 style="color: black;">${customer.email}</p1></h5>
    </div>
    <h1 class="fa fa-align-center text-center" aria-hidden="true" style="margin-top: 50px;">List of Trips of Customer</h1> 
        <table class="table table-striped text-center " align="center">
            ...
            for(TripBooking trip : list)
            {
                ...
                if(trip.getStatus()){
                  out.println("<td style=\"color : green;\">"+"Booked"+" </td>");
                }
                else{
        ...
        <a href="/admin/tripsofcustomer" ><button class="btn" style="background-color: #ffc107; margin-top : 20px;"><span>&#8592</span> Go Back</button></a>
    </div>
</div>
...
<section class="container-fluid footer_section">
  <div class="container">
    <p>
      ...
      <a href="../../https://html.design/">UROTAXI</a>
    </p>
  </div>
</section>
  <!-- footer section -->
