  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <form:input type="datetime-local" min="{{ datetime.now().strftime('%Y-%m-%dT%H:%M') }}" id="datetime" required="true"  path="fromDateTime" 
      ...
      <div class="form-group">
        <button type="submit" class="btn" style= "background-color:#ffc107;">Proceed</button>
      </div>
</form:form>
