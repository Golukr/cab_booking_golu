...
import="java.util.*,org.demoProject.model.*,java.time.*"
%>
...
<body class="sub_page">
  ...
  <div class="container " style= "background-color:white; margin: auto; padding-top: 50px; margin-bottom: 50px;">
    <h1 class="fa fa-align-center text-center" aria-hidden="true">List of Your Trips</h1> 
        <table class="table table-striped text-center " align="center">
            ...
            for(TripBooking trip : list)
            {
                ...
                if(trip.getStatus() && trip.getFromDateTime().isAfter(now)){
                  ...
                  out.println("<td style=\"color : red;\">"+"Completed"+" </td>");
                }
                else{
