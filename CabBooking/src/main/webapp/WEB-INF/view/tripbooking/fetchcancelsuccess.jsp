...
<body class="sub_page">
  ...
  <div class="alert alert-warning alert-dismissible text-center" >
    <!-- <a href="#" class="close" data-dismiss="alert" aria-label="close">Cancel</a> -->
    <strong>Warning!</strong> Confirm you cancelation 
  </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <form:input path="driverId.userName" value="${trip.driverId.userName}"
                  class="form-control" name="" id="driver"/>
              </div>
        <div class="form-group">
          <button type="submit" class="btn" style= "background-color:#ffc107;">Cancel Trip</button>
        </div>
  </form:form>
