...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
    <h2 class="text text-center" style="margin: 50px; color: #ffc107;">Sorry! We are out of 
    <%
        TripBooking trip = (TripBooking) request.getAttribute("trip");
        out.println(trip.getDriverId().getCab().getCarType());
    %>

    </h2>
    <a href="settrip"><button class="btn" style="background-color: #ffc107; "><span>&#8592</span> Go Back</button></a>
</div>
