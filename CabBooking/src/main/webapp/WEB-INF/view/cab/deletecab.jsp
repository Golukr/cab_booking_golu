...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
    <form:form action="fetchdeletecab" modelAttribute="cab" method="post"> 
    <div class="form-group">
      <label for="cabId"><h2>Cab Id</h2></label>
      <form:input path="cabId" 
        class="form-control" name="" id="cabId"/>
    </div>
    
    <div class="form-group">
        <button type="submit" class="btn" style= "background-color:#ffc107;">Fetch Cab Record</button>
    </div>
</form:form>
</div>
