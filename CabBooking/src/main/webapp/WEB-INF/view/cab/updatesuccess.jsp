...
<body class="sub_page">
  ...
  <div class="text text-center" style="margin-bottom: 50px;">
    <h1 class="text text-center" style="margin: 50px; color: #ffc107;">Cab modified successfully</h1>



  <a href="/cab/updatecab"><button class="btn" style="background-color: #ffc107; margin-top: 10px;"><span>&#8592</span> Go Back</button></a>
  </div>
