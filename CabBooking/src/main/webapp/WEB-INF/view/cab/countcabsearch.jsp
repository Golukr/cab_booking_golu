...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">		
    <form:form action="countcabtypes" modelAttribute="cab" method="post">
    ...
    <div class="form-group">
      <label for="cab">Cab Type</label>
        ...
        List<Cab> list = (List<Cab>) request.getAttribute("lists");
          for(Cab cab : list){
            out.println("<option>" + cab.getCarType() + "</option>");
          }
        %>
      </form:select>
    </div>
			
      <button type="submit" class="btn" style= "background-color:#ffc107;">Fetch Cab Count</button>
		</form:form>
