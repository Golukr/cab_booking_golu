...
<div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
  <form:form action="deletecabprocess" modelAttribute="cab" method="post"> 
  ...
  <div class="form-group">
      <label for="perKmRate">Rate/Km</label>
      <form:input path="perKmRate" 
        class="form-control" name="" id="ratePerKm"/>
    </div>
    <div class="form-group">
