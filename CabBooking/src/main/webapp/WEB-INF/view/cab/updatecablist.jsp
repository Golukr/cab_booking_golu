...
<body class="sub_page">
  ...
  <div class="container " style= "background-color:white; margin: auto; padding-top: 50px; margin-bottom: 50px;">
    <h1 class="fa fa-align-center text-center" aria-hidden="true">List Of Cabs</h1> 
        ...
        <a href="../../../cab.html" ><button class="btn" style="background-color: #ffc107; margin-top : 20px;"><span>&#8592</span> Go Back</button></a>
    </div>
</div>
