...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; margin-bottom: 50px;">
    <h1 class="fa fa-align-center  text-center" aria-hidden="true">List of Trips</h1> 
        <table class="table table-striped  text-center" align="center">
            ...
            <c:forEach items="${lists}" var="tripbooking">
                <tr>
                    ...
                    <td>${tripbooking.driverId.driverId}</td>
                </tr>
            </c:forEach>
        </table>
        <a href="../../../customer.html" ><button class="btn" style="background-color: #ffc107; margin-top : 20px;"><span>&#8592</span> Go Back</button></a>
    </div>
</div>
