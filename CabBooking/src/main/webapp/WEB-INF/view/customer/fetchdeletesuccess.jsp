...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
    ...
    <div class="form-group">
      ...
      <form:input disabled="true" path="userName" value="${customer.userName}"
        class="form-control" name="" id="userName"/>
    </div>
    <div class="form-group">
        <label for="password">Password</label>
        <form:input disabled="true" path="password" value="${customer.password}"
          class="form-control" name="" id="password"/>
      </div>
      <div class="form-group">
        <label for="mobileNumber">Mobile No</label>
        <form:input disabled="true" path="mobileNumber" value="${customer.mobileNumber}"
          class="form-control" name="" id="mobileNumber"/>
      </div>
      <div class="form-group">
        <label for="email">Email id</label>
        <form:input disabled="true" path="email" value="${customer.email}"
          class="form-control" name="" id="email"/>
      </div>
      <div class="form-group">
        <button type="submit" class="btn" style= "background-color:#ffc107;">Delete Record</button>
      </div>
</form:form>
