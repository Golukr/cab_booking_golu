...
<body class="sub_page">
  ...
  <div class="hero_area">
    ...
    <div class="container" style= " size:400px;background-color:white; margin: auto; padding-top: 150px; width:600px;">
      <h2 class="text text-center" style="margin: 50px; color: #ffc107;">Record Not Found</h2>
