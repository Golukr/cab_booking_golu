...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
    <form:form action="addtrip" modelAttribute="trip" method="post"> 
    ...
    <div class="form-group">
      ...
      <form:input path="fromLocation" 
        class="form-control" name="" id="fromLocation"/>
    </div>
    <div class="form-group">
        <label for="toLocation">Drop</label>
        <form:input path="toLocation" 
          class="form-control" name="" id="toLocation"/>
      </div>
      <div class="form-group">
        <label for="fromDateTime">FromDate</label>
        <form:input path="fromDateTime" 
          class="form-control" name="" id="fromDateTime"/>
      </div>
      <div class="form-group">
          <label for="toDateTime">TOdate</label>
          <form:input path="toDateTime" 
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="driver">DriverId</label>
