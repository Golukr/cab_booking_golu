...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
    <form:form action="fetchdeletecustomer" modelAttribute="customer" method="post"> 
    ...
    <div class="form-group">
      <button type="submit" class="btn" style= "background-color:#ffc107;">Fetch Customer Record</button>
    </div>
</form:form>
</div>
