...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">      
        <h2 class="text text-center" style="margin: 50px; color: #ffc107;">Driver Registered successfully</h2>
        <div class="form-group d-flex justify-content-between">
          <a href="../../../admin.html"><button class="btn" style="background-color: #ffc107; "><span>&#8592</span> Go Back</button></a>

          
          <a href="/driver/adddriver"><button class="btn" style="background-color: #ffc107; ">Add More <span>&#8853 </span></button></a>
