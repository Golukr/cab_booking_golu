...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">
		<form:form action="fetchupdatedriver" modelAttribute="driver" method="post">
      ...
      <button type="submit" class="btn" style= "background-color:#ffc107;">Fetch driver Details</button>
		</form:form>
	</div>
