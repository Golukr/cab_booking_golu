...
<body class="sub_page">
  ...
  <div class="hero_area">
    ...
    <div class="container" style= "background-color:white; margin: auto; padding-top: 90px; width:600px; margin-bottom: 50px;">

        <form:form action="adddriver" modelAttribute="driver" method="get"> 
          <h2 class="text text-center" style="margin: 50px; color: #ffc107;">Looks like you are not Registered!</h2>
    </form:form>
    <a href="/driver/login" ><button class="btn" style="background-color: #ffc107;"><span>&#8592</span> Go Back</button></a>
